...
public class AppConfig : ConfigObject
{
    ...
    public HashSet<string> IgnoreDirs { get; private init; } = new();
    public HashSet<string> IgnoreFiles { get; private init; } = new();
    ...
    private static List<string> NormalizeExt(List<string> exts)
    {
        ...
        return outList.Count > 0 ? outList : new List<string> { "*" };
    }
}